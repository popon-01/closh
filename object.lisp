...
(define-class closh-quasiquote (closh-special) (name "quasiquote"))
(define-class closh-unquote (closh-special) (name "unquote"))
(define-class closh-unquote-splicing (closh-special) (name "unquote-splicing"))
